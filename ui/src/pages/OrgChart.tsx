...
export function OrgChart() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message={t("page.orgChart.selectCompany")} />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message={t("page.orgChart.empty")} />;
  }
    ...
    >
      ...
      <div className="absolute top-3 right-3 z-10 flex flex-col gap-1">
        ...
        <button
          ...
          title={t("tooltip.fitToScreen")}
          aria-label={t("tooltip.fitChartToScreen")}
        >
          {t("btn.fit")}
        </button>
      </div>
