...
const getLevelLabels = (t: (key: string) => string): Record<string, string> => ({
  company: t("goal.level.company"),
  team: t("goal.level.team"),
  agent: t("goal.level.agent"),
  task: t("goal.level.task"),
});
